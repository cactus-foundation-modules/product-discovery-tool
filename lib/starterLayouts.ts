  ...
  return [
    {
      ...
      data: {
        content: [
          ...
          block('ProductDiscovery', 'discovery-1', { columns: 3, imageLoading: 'auto', questionsPosition: 'left', autoOpenQuestions: 'no', drawerOptions: 'side-by-side', firstStepFoot: 'hide', defaultSort: 'best-selling', barButtonBg: '', barButtonText: '', barButtonHoverBg: '', barButtonHoverText: '' }),
        ],
        root: { props: {} },
        zones: {},
      },
    },
    {
      ...
      data: {
        content: [block('ProductDiscovery', 'discovery-1', { columns: 3, imageLoading: 'auto', questionsPosition: 'left', autoOpenQuestions: 'no', drawerOptions: 'side-by-side', firstStepFoot: 'hide', defaultSort: 'best-selling', barButtonBg: '', barButtonText: '', barButtonHoverBg: '', barButtonHoverText: '' })],
        root: { props: {} },
        zones: {},
      },
    },
