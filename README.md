...
3. **What matters to you?** The products are already on screen. Every question is asked - the important ones first - and ticking narrows what is shown with no reload. Questions run down the side, or **across the top** of the products where the block says so: a row of controls that arrive shut and open one at a time across the full width with their options side by side. They scroll away with the page, and a "Narrow down" button - the phone's own, in the phone's own colours - floats at the top of the window once they have gone, to take the shopper back. On a tablet or a phone both settings do the same thing: the questions sit behind a "Narrow down" bar, because a row of questions above the products is a wall between a phone and the shop.
